// src/components/creative/FramerMotion.jsx
import React, { useState } from 'react';
import { Link, useLocation } from 'react-router-dom';
import { File } from 'lucide-react';

// Import all components from the current directory
const componentContext = import.meta.glob('./*.jsx', { eager: false });

// Filter out FramerMotion.jsx itself and create components list
const componentsList = Object.keys(componentContext)
  .filter(path => !path.includes('FramerMotion.jsx'))
  .map(path => {
